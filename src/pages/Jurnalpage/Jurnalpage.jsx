...
<div className='isijurnal'>
  ...
  <div className='isij'>
    <div className='buku'>
      ...
      <h5>IMPLEMENTASI PANCASILA DALAM MENGHADAPI MASALAH RASISME DAN DISKRIMINASI</h5>
      ...
      <NavLink to='https://journal.upy.ac.id/index.php/pkn/article/view/1448'><button className='btn btn-danger'>Selengkapnya</button></NavLink>
    </div>
    <div className='buku'>
      <img src={Buku} />
      <h5>IMPLEMENTASI PANCASILA DALAM MENGHADAPI MASALAH RASISME DAN DISKRIMINASI</h5>
